...
public class Controller {
	...
	public void addAcceptPanel(MainFrame frame,BelowPanel acceptPanel) {
		frame.add(acceptPanel,BorderLayout.SOUTH);
		frame.revalidate();
	}
	public void addPatientAndWriteToJson(MainFrame mainFrame, AddPatientFrame addPatientFrame,PatientTableModel patientTableModel) {
