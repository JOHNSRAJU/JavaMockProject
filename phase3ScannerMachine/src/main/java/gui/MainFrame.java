...
public class MainFrame extends JFrame{
	...
	public MainFrame() {
		...
		patientTablePanel = new PatientTablePanel(patientTableModel,(patient)->{
			...
			controller.addAcceptPanel(this,belowPanel);
		});
		belowPanel = new BelowPanel(() ->{
			this.setEnabled(false);
			this.scanningWindow = new ScanningWindow(this,selectedPatient);
		},()->{
			addUserFrame = new AddPatientFrame(this,selectedPatient,(form)->{
				controller.updateForm(addUserFrame, patientTableModel, form, selectedPatient);
			});
		});
		...
		addButtonPanel = new AddButtonPanel(controller,()->{
			addUserFrame = new AddPatientFrame(this,()->{
				controller.addPatientAndWriteToJson(this,addUserFrame, patientTableModel);
			});
		},patientTableModel);
