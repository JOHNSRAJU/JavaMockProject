...
import controller.ScanningController;
...
public class ScanningWindow extends JDialog{
	...
	public ScanningWindow(MainFrame mainFrame, Patient patient){
		...
		ScanningController.addExitButtonListener(exitButton,progressBar,this,mainFrame);
		add(buttonPanel,BorderLayout.SOUTH);
		//startProgressBar();
		setVisible(true);
		
		ScanningController.addCompleteButtonListener(completeButton,this, mainFrame, patient,mainFrame.getPatientTableModel());
	}
